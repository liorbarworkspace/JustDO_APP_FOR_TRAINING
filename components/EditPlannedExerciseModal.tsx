    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex justify-center items-center z-50 p-4" onClick={onClose}>
            <div className="bg-slate-800 rounded-lg shadow-2xl p-6 md:p-8 max-w-md w-full text-right border border-cyan-500" onClick={e => e.stopPropagation()}>
                <h2 className="text-2xl font-bold mb-2 text-cyan-400">עריכת תרגיל</h2>
                <p className="text-gray-400 mb-6">שינוי פרטי התרגיל: <span className="font-semibold text-white">{exercise.name}</span></p>
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <label htmlFor="duration" className="block mb-2 text-sm font-medium text-gray-300">משך (בשניות)</label>
                        <input
                            type="number"
                            id="duration"
                            name="duration"
